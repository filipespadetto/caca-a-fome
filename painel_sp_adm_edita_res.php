...
<body>
    ...
    <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-warning" style="width: 100%">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="painel_sp_adm_add_adm.php">Incluir administrador</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="alteraRestaurante">
            <h4>Alterar dados do restaurante</h4>
            <br>

            <form method="POST" action="php/deleta_restaurante.php">
                <h5>Deletar dados do restaurante</h5>
                <br>
                <div class="form-group row">
                    <label for="inputNome" class="col-sm-2 col-form-label">Pesquise pelo nome</label>
                    <div class="col-sm-6">
                        <select class="custom-select" style="width: 100%" name="idNome" id="idNome">
                            <option value="<?php NULL ?>" selected>Selecione...</option>
                            <?php
                                $query = $conn->query("SELECT * FROM restaurante");
                                while($row = $query->fetch_assoc()){
                                    echo "<option value=".$row["id_restaurante"].">".utf8_encode($row["nome_restaurante"])."</option>";
                                }
                            ?>
                        </select>
                    </div>
            ...
            <form method="POST" action="php/teste_update.php">
                <h5>Atualizar dados do restaurante</h5>
                <br>
                <div class="form-group row">
                    <label for="inputNome" class="col-sm-2 col-form-label">Pesquise pelo nome</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                    <input type="submit" value="Atualizar" name="atualizar" class="btn btn-success">
                    </div>
                </div>
            </form>
        </div>
